...
export default function HomePage() {
  return (
    <div>
      ...
      <div className="relative min-h-screen flex items-center justify-center -mt-32 pt-32">
        <HeroBackgroundSlideshow />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center text-white relative z-10">
