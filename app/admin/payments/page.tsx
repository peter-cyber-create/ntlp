  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Monitor and manage conference payments</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Payment records will appear here once payments are processed.</p>
        </div>
      </div>
    </div>
  )
