        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-yellow-300">
              ...
              <p className="mb-4 text-gray-700">Please make your payment using the following bank details. After payment, email your proof of payment to <b>conference@health.go.ug</b> with your full name and partnership details.</p>
              <div className="mb-6">
