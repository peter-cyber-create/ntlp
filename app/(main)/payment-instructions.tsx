      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-yellow-300">
            ...
            <div className="bg-yellow-100 border border-yellow-300 rounded-xl p-6 mt-8">
              <h3 className="text-lg font-bold text-yellow-800 mb-2 flex items-center"><span className="mr-2">ℹ️</span> Important Payment Notes</h3>
              <ul className="list-disc pl-5 text-yellow-900 text-base space-y-2">
                <li>Include your full name and registration/abstract details in your payment reference.</li>
                <li>Keep your payment receipt and send proof to <b>conference@health.go.ug</b>.</li>
                <li>Registration is only confirmed after payment is received and verified.</li>
                <li>Contact the conference secretariat for any payment queries.</li>
              </ul>
            </div>
          </div>
        </div>
